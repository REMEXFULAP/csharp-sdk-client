...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse2003 :  IEquatable<InlineResponse2003>, IValidatableObject
    {
        ...
        public InlineResponse2003(List<InlineResponse2003Items> items = default(List<InlineResponse2003Items>), int? pg = default(int?), int? pgSize = default(int?), int? pages = default(int?), int? total = default(int?), bool? allowNext = default(bool?))
        {
            this.Items = items;
            this.Pg = pg;
            this.PgSize = pgSize;
