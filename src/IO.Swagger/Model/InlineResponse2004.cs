...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse2004 :  IEquatable<InlineResponse2004>, IValidatableObject
    {
        ...
        /// <param name="total">Total de tarjetas.</param>
        public InlineResponse2004(List<InlineResponse2004Items> items = default(List<InlineResponse2004Items>), int? total = default(int?))
        {
            this.Items = items;
            this.Total = total;
        }
