...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse2002 :  IEquatable<InlineResponse2002>, IValidatableObject
    {
        ...
        /// <param name="lockStatus">lockStatus.</param>
        /// <param name="error">error.</param>
        public InlineResponse2002(bool? success = default(bool?), string lockStatus = default(string), string error = default(string))
        {
